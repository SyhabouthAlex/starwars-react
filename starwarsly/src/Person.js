/**
     * Person Component
     * If the person doesn't exist in state, the action to get the person's data by their ID
     * is called in useEffect. Shows person's data along with films and planets
